...
class Recipe < ApplicationRecord
    ...
    validates :description,
            length: { in: 5..100, wrong_length: "Descript needs to be between 5 and 100 characters."},
            format: { with: /[A-Za-z0-9 ]/, 
            only_letters_numbers: "Description should only have letters, numbers, and spaces."},
            presence: true            
    ...
    validates :fileName, format: { with: /[A-Za-z0-9]/, only_letters: "Special Date should only have letters and numbers." },
            uniqueness: true

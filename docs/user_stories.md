...
- US 18 Delete account
 ...
 - US19 Add/modify ingredients to a Drink Recipe
  - Description: As an account-holder, I should be able to add and modify the ingredients for a drink recipe, so insure the recipe has the right ingredients.
  - Estimate: 1
  - Priority: 90
  - Status: Not started  

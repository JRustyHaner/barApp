...
Recipe_4 = Recipe.new(drinkDate: "02/11/2019", drinkLocation: 'USA', drinkName: 'Salted Lassi', specialDate: 'None', fileName: 'None', description: 'Lassi is very popular drinks in Bangladesh. There are many types of lassi, sweet lassi, salted lassi, banana lassi, rose lassi, spicy lassi etc. It is a one kind of street food drinks in Bangladesh')
